# Adicione ao modulo uma função chamada de resumo() que mostre algumas informações geradas pelas funções que ja temos no modulo criado até aqui
...
def resumo(_, n1, n2):
    """
    -> Mostra um resumo das informações
    :param _: Valor relatado
    :param n1: Valor percentural que vai ser acrecentado
    :param n2: Valor percentual que vai ser reduzido
    :return: none
    """
    aumento = _ + (_ * n1 / 100)
    redução = _ - (_ * n2 / 100)
